%主函数  Main
%子函数  CoarseConnection 利用bounding box获取初始连接关系 双阈值
%        LowThresold低阈值, HighThresold高阈值用于筛选
%子函数  Validation  对于在双阈值中的部分使用分割信息进行校验  分割阈值Threshold2=0.03;正则化参数lambda=0.5;  并给与不同的类别标签
